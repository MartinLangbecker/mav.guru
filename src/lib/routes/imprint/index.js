...
const head = (api) => {
  const elements = [
    ...
    h('link', {
      rel: 'stylesheet',
      type: 'text/css',
      href: '/assets/styles/imprint.css',
    }),
  ];
    ...
    h('body', [
      h('div#page', [
        ...
        h('div', { class: 'section' }, [
          h(
            'p',
            'Es werden keine personenbezogenen Daten gespeichert. Für Verbindungsanfragen werden Start- und Zielpunkt, sowie gewählte Optionen (Reisedauer, Anzahl der Umstiege, etc.), anonymisiert an das Verkehrsunternehmen geschickt. Ansonsten erfolgt keine Weitergabe von Daten an Dritte.'
          ),
        ]),
      ]),
      h('div#footer', [
...
export default createImprintRoute;
